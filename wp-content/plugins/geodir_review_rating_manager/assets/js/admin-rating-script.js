...
function geodir_init_admin_rating(){
    ...
    jQuery('.rating_checkboxs').click(function(){
        ...
        if(jQuery(this).is(':checked')){
            ...
            jQuery.post(geodir_reviewrating_all_js_msg.geodir_reviewrating_admin_ajax_url+"&action=geodir_ajax_tax_cat",{post_type: val})
                .done(function(data) {
    ...
    if (jQuery(".geodir-style-list .geodir-style-set-default").length) {
        jQuery(".geodir-style-list .geodir-style-set-default").click(function(e) {
