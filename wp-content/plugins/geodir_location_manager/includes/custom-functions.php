        ...
        function gd_location_error_done() {
            if (loc_error_checking_start_count != loc_error_checking_end_count) {
                ...
                if (error == false) {
                    ...
                    if (getZip) {
                        if (getCountryISO == 'SK' || getCountryISO == 'TR' || getCountryISO == 'DK' || getCountryISO == 'ES' || getCountryISO == 'CZ' || getCountryISO == 'LV' || getCountryISO == 'HU') {
