...
function geodir_advance_search_options_output( $terms, $taxonomy_obj, $post_type, $title = '' ) {
    ...
    $display_label = $has_fieldset ? '<label for="geodir_search_' . $taxonomy_obj->htmlvar_name . '">' . $field_label . '</label>' : '';
    $field_class = 'gd-search-li-' . (int) $has_fieldset . ' gd-search-li-' . $taxonomy_obj->htmlvar_name;
    ...
    if ( $taxonomy_obj->input_type == 'SELECT' ) {
        ...
        if ( empty( $taxonomy_obj->main_search ) ) {
            $geodir_search_field_begin = '<li class="' . $field_class . '">' . $display_label;
        }
        $geodir_search_field_begin .= '<select name="' . $htmlvar_name . '" class="cat_select" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '"' . $aria_label . '><option value="" >' . $select_default  . '</option>';
        ...
        $geodir_search_field_begin = '<li class="' . $field_class . '">' . $display_label . '<ul>';
            ...
            switch ( $taxonomy_obj->input_type ) {
                case 'CHECK' :
                    if ( $custom_term && $optgroup != '' ) {
                        ...
                        echo '<li ' . $classname . '><input type="checkbox" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'" class="cat_check" name="s' . $taxonomy_obj->htmlvar_name . '[]" ' . $geodir_search_field_selected_str . ' value="' . $term->term_id . '" /> <label for="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'">' . __( $term->name, 'geodirectory' ) . '</label></li>';
                        $increment ++;
                    }
                    break;
                case 'RADIO' :
                    if ( $custom_term && $optgroup != '' ) {
                        ...
                        echo '<li ' . $classname . '><input type="radio" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'" class="cat_check" name="s' . $taxonomy_obj->htmlvar_name . '[]" ' . $geodir_search_field_selected_str . ' value="' . $term->term_id . '" /> <label for="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'">' . __( $term->name, 'geodirectory' ) . '</label></li>';
                        $increment ++;
                    }
                    break;
                case 'SELECT' :
                    ...
                    switch ( $taxonomy_obj->search_condition ) {
                        ...
                        case 'SINGLE':
                            ...
                            <input type="text" class="cat_input"
                                   name="s<?php echo $taxonomy_obj->htmlvar_name; ?>"
                        ...
                        case 'FROM':
                            ...
                            <input type='number' min="0" step="1"
                                   class='cat_input <?php echo $taxonomy_obj->htmlvar_name; ?>'
                                   placeholder='<?php echo $start_placeholder; ?>'
                                   name='smin<?php echo $taxonomy_obj->htmlvar_name; ?>'
                                   value='<?php echo $smincustom_value; ?>'>
                            <input type='number' min="0" step="1"
                                   class='cat_input <?php echo $taxonomy_obj->htmlvar_name; ?>'
                                   placeholder='<?php echo $end_placeholder; ?>'
                                   name='smax<?php echo $taxonomy_obj->htmlvar_name; ?>'
                        ...
                        case 'SELECT':
                            ...
                            ?>
                            <li><select name="s<?php echo $taxonomy_obj->htmlvar_name; ?>"
                                        class="cat_select"
                        ...
                        case 'RADIO':
                            ...
                            for ( $i = $dist_dif; $i <= $search_maximum_value; $i = $i + $dist_dif ) :
                                ...
                                echo '<li ' . $classname . '><input type="radio" class="cat_check" name="' . esc_attr( $htmlvar_name ) . '" ' . $checked . ' value="' . $i . '" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $i . '"  /> <label for="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $i .'">' . __( 'Within', 'geodiradvancesearch' ) . ' ' . $i . ' ' . __( $uom, 'geodirectory' ) . '</label></li>';
                                $increment ++;
                            endfor;
                            break;
                ...
                default:
                    if ( isset( $taxonomy_obj->field_type ) && $taxonomy_obj->field_type == 'checkbox' ) {
                        ...
                        echo '<li><input ' . $checked . ' type="' . $field_type . '" for="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'" class="cat_input" name="s' . $taxonomy_obj->htmlvar_name . '"  value="1" /> <label for="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'">' . __( 'Yes', 'geodiradvancesearch' ) . '</label></li>';
                        ...
                        echo '<li>' . $display_label . '<input type="text" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '" class="cat_input" name="s' . $taxonomy_obj->htmlvar_name . '" value="' . esc_attr( $geodir_search_custom_value_str ) . '" placeholder="' . esc_attr( $field_label ) . '"' . $aria_label . ' /></li>';
                    }
            }
...
function geodir_advance_search_more_filters() {
    ...
    if($design_style){
        ...
        <div class="geodir-filter-container">
            <div
                class="geodir-more-filters customize_filter-in clearfix <?php echo 'gd-filter-' . $stype; ?>" <?php echo $style; ?>>
...
function geodir_search_before_widget_content( $before_widget, $args, $instance, $super_duper ) {
    ...
    $before_widget = str_replace( 'id="' . $args['widget_id'] . '"', 'id="' . $args['widget_id'] . '"' . $attrs, $before_widget );
            ...
            switch( $field->input_type ) {
                case 'RANGE': {
                    switch( $field->search_condition ) {
                        case 'SINGLE': {
                            if ( isset( $_REQUEST['s' . $htmlvar_name] ) && $_REQUEST['s' . $htmlvar_name] !== '' ) {
                                $params[] = '<label class="' . $label_class . ' gd-adv-search-range gd-adv-search-' . $htmlvar_name . '" data-name="s' . $htmlvar_name . '"><i class="fas fa-times" aria-hidden="true"></i> ' . sanitize_text_field( $_REQUEST['s' . $htmlvar_name] ) . '</label>';
                            }
                        }
                            break;
                        case 'FROM': {
                            ...
                            if ( $this_search != '' ) {
                                $extra_attrs = 'data-name="smin' . $htmlvar_name . '" data-names="smax' . $htmlvar_name . '"';
                                $params[] = '<label class="' . $label_class . ' gd-adv-search-range gd-adv-search-' . $htmlvar_name . '" ' . $extra_attrs . '><i class="fas fa-times" aria-hidden="true"></i> <label class="' . $sublabel_class . '">' . $frontend_title . ': </label>' . $this_search . '</label>';
                            }
                        }
                            break;
                        case 'RADIO': {
                            ...
                            if (isset( $_REQUEST[ $htmlvar_name ] ) && $_REQUEST[ $htmlvar_name ] !== '' ) {
                                $uom = geodir_adv_search_distance_unit();
                                $extra_attrs = 'data-name="' . $htmlvar_name . '"';
                        ...
                        default : {
                            if (isset( $_REQUEST['s' . $htmlvar_name] ) && $_REQUEST['s' . $htmlvar_name] !== '' ) {
                                ...
                                if (!empty( $serchlist) ) {
                                    ...
                                    if ( $this_search != '' ) {
                                        $extra_attrs = 'data-name="s' . $htmlvar_name . '"';
                                        $params[] = '<label class="' . $label_class . ' gd-adv-search-range gd-adv-search-' . $htmlvar_name . '" ' . $extra_attrs . '><i class="fas fa-times" aria-hidden="true"></i> <label class="' . $sublabel_class . '">' . $frontend_title . ': </label>' . $this_search . '</label>';
                                    }
                                }
                            }
                ...
                case 'DATE': {
                    if ( ! empty( $_REQUEST[ $htmlvar_name ] ) && ( $field->data_type == 'DATE' || $field->data_type == 'TIME' ) ) {
                        ...
                        if ( is_array( $value ) ) {
							...
							if ( ! $design_style ) {
								$extra_attrs = 'data-name="' . $htmlvar_name . '[from]" data-names="' . $htmlvar_name . '[to]"';
							}
                        ...
                        if ( $filters != '' ) {
                            $params[] = '<label class="' . $label_class . ' gd-adv-search-date gd-adv-search-' . $htmlvar_name . '" ' . $extra_attrs . '><i class="fas fa-times" aria-hidden="true"></i> <label class="' . $sublabel_class . '">' . $frontend_title . ': </label>' . $filters . '</label>';
                        }
                    }
                }
                    break;
                default: {
                    if (isset( $_REQUEST['s' . $htmlvar_name] ) && ( ( is_array( $_REQUEST['s' . $htmlvar_name] ) && !empty( $_REQUEST['s' . $htmlvar_name] ) ) || ( ! is_array(  $_REQUEST['s' . $htmlvar_name] ) && $_REQUEST['s' . $htmlvar_name] !== '' ) ) ) {
                        ...
                        if ( $value != '' ) {
                            $params[] = '<label class="' . $label_class . ' gd-adv-search-default gd-adv-search-' . $htmlvar_name . '" ' . $extra_attrs . '><i class="fas fa-times" aria-hidden="true"></i> ' . $value . '</label>';
                        }
                    }
                }
                    break;
...
function geodir_advance_search_options_output_aui( $terms, $taxonomy_obj, $post_type, $title = '' ) {
    ...
    $display_label = $has_fieldset ? '<label for="geodir_search_' . $taxonomy_obj->htmlvar_name . '" class="'.$label_hide.'"">' . $field_label . '</label>' : '';
    $field_class = 'gd-search-li-' . (int) $has_fieldset . ' gd-search-li-' . $taxonomy_obj->htmlvar_name;
    $aria_label = ! $display_label || ! empty( $taxonomy_obj->main_search ) ? ' aria-label="' . esc_attr( $field_label ) . '"' : '';
    ...
    if ( $taxonomy_obj->input_type == 'SELECT' ) {
        ...
        if ( !empty( $taxonomy_obj->main_search ) ) {
            $geodir_search_field_begin = '<div class="form-group">' . $display_label;
        }
        $geodir_search_field_begin .= '<select name="' . $htmlvar_name . '" class="cat_select custom-select form-control" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '"' . $aria_label . '><option value="" >' . $select_default  . '</option>';
            ...
            switch ( $taxonomy_obj->input_type ) {
                case 'CHECK' :
                    if ( $custom_term && $optgroup != '' ) {
                        ...
                        echo '<div class="form-check '.$classname.' as-'.$classname.'-'.$taxonomy_obj->htmlvar_name.' "><input type="checkbox" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'" class="form-check-input" name="s' . $taxonomy_obj->htmlvar_name . '[]" ' . $geodir_search_field_selected_str . ' value="' . $term->term_id . '" /> <label for="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'" class="form-check-label text-muted">' . __( $term->name, 'geodirectory' ) . '</label></div>';
                        $increment ++;
                    }
                    break;
                case 'RADIO' :
                    if ( $custom_term && $optgroup != '' ) {
                        ...
                        echo '<div class="form-check '.$classname.' as-'.$classname.'-'.$taxonomy_obj->htmlvar_name.' "><input type="radio" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'" class="form-check-input" name="s' . $taxonomy_obj->htmlvar_name . '[]" ' . $geodir_search_field_selected_str . ' value="' . $term->term_id . '" /> <label for="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $count .'" class="form-check-label text-muted">' . __( $term->name, 'geodirectory' ) . '</label></div>';
                        $increment ++;
                    }
                    break;
                case 'SELECT' :
...

                {
                    ...
                    switch ( $taxonomy_obj->search_condition ) {
                        ...
                        case 'SINGLE':
                            $custom_value = isset( $_REQUEST[ 's' . $taxonomy_obj->htmlvar_name ] ) ? stripslashes_deep( esc_attr( $_REQUEST[ 's' . $taxonomy_obj->htmlvar_name ] ) ) : '';
                            ?>
                            <div class="form-group" data-argument="<?php echo $taxonomy_obj->htmlvar_name; ?>"><?php echo $display_label; ?><input type="text" class="cat_input form-control w-100" name="s<?php echo $taxonomy_obj->htmlvar_name; ?>" value="<?php echo esc_attr( $custom_value ); ?>" placeholder="<?php echo esc_attr( $field_label ); ?>"/></div> <?php
                            break;
                        ...
                        case 'FROM':
                            ...
                            $end_placeholder   = apply_filters( 'gd_adv_search_from_end_ph_text', esc_attr( __( 'End search value', 'geodiradvancesearch' ) ), $taxonomy_obj );
                            ?>
                            <div class="form-group" data-argument="<?php echo $taxonomy_obj->htmlvar_name; ?>"><?php echo $display_label; ?><div class='input-group'>
                            <input type='number' min="0" step="1"
                                   class='cat_input form-control <?php echo $taxonomy_obj->htmlvar_name; ?>'
                                   placeholder='<?php echo $start_placeholder; ?>'
                                   name='smin<?php echo $taxonomy_obj->htmlvar_name; ?>'
                                   value='<?php echo $smincustom_value; ?>'>
                            <input type='number' min="0" step="1"
                            ...
                            break;
                        case 'LINK':
                            echo '<div class="form-group"><ul class="list-group">';
                        ...
                        case 'SELECT':
                            ...
                            ?>
                            <li><div class="form-group" data-argument="<?php echo $taxonomy_obj->htmlvar_name; ?>"><?php echo $display_label; ?><select name="s<?php echo $taxonomy_obj->htmlvar_name; ?>" class="cat_select custom-select form-control" id="<?php echo 'geodir_search_' . $taxonomy_obj->htmlvar_name; ?>"<?php echo $aria_label; ?>>
                        ...
                        case 'RADIO':
                            ...
                            for ( $i = $dist_dif; $i <= $search_maximum_value; $i = $i + $dist_dif ) :
                                ...
                                echo '<div class="form-check '.$classname.' as-'.$classname.'-'.$taxonomy_obj->htmlvar_name.'"><input type="radio" class="form-check-input" name="' . esc_attr( $htmlvar_name ) . '" ' . $checked . ' value="' . $i . '" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $i . '"  /> <label for="geodir_search_' . $taxonomy_obj->htmlvar_name . '-' . $i .'" class="form-check-label text-muted">' . __( 'Within', 'geodiradvancesearch' ) . ' ' . $i . ' ' . __( $uom, 'geodirectory' ) . '</label></div>';
                                $increment ++;
                            endfor;
                            break;
                ...
                default:
                    if ( isset( $taxonomy_obj->field_type ) && $taxonomy_obj->field_type == 'checkbox' ) {
                        ...
                        echo '<li>' . $display_label . '<input type="text" id="geodir_search_' . $taxonomy_obj->htmlvar_name . '" class="cat_input form-control" name="s' . $taxonomy_obj->htmlvar_name . '" value="' . esc_attr( $geodir_search_custom_value_str ) . '" placeholder="' . esc_attr( $field_label ) . '"' . $aria_label . ' /></li>';
                    }
            }
