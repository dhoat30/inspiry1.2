...
require get_theme_file_path('/inc/nav-registeration.php');
 ...
 function inspiry_scripts(){ 
   ...
   if (strstr($_SERVER['SERVER_NAME'], 'localhost')) {
      ...
      wp_enqueue_script('main', get_theme_file_uri('/bundled-assets/scripts.32cd646ad5f5bc4cd85d.js'), NULL, '1.0', true);
      wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.32cd646ad5f5bc4cd85d.css'));
    }
