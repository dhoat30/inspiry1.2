...
require get_theme_file_path('/inc/nav-registeration.php');
 ...
 function inspiry_scripts(){ 
   ...
   if (strstr($_SERVER['SERVER_NAME'], 'localhost')) {
      ...
      wp_enqueue_script('main', get_theme_file_uri('/bundled-assets/scripts.b1112a10eb77805be3da.js'), NULL, '1.0', true);
      wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.b1112a10eb77805be3da.css'));
    }
